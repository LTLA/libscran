...
TEST(SampleScaledWrapperTest, EigenDense) {
    size_t NR = 30, NC = 10;
    ...
    scran::pca_utils::SampleScaledWrapper<decltype(thing)> batched(&thing, &weights);
...
TEST(SampleScaledWrapperTest, CustomSparse) {
    size_t NR = 30, NC = 10;
    ...
    {
        scran::pca_utils::SampleScaledWrapper<decltype(ref)> batchedref(&ref, &weights);
